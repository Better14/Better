...
func InMyCode(x *Imported, y *HasAMethod, z *other.Exported) {
	...
	y.Do()
	y.do() // ERROR "y\.do undefined \(type \*HasAMethod has no field or method do, but does have method Do\)|reference to undefined field or method"
	(*y).Do()
	(*y).do()   // ERROR "\(\*y\)\.do undefined \(type HasAMethod has no field or method do, but does have method Do\)|reference to undefined field or method"
	...
	z.do() // ERROR "z\.do undefined \(type \*other\.Exported is pointer to interface, not interface\)|type that is pointer to interface"
	(*z).Do()
	(*z).do()     // ERROR "\(\*z\)\.do undefined \(type other.Exported has no field or method do, but does have method Do\)|reference to undefined field or method"
	...
	(*z).secret() // ERROR "\(\*z\)\.secret undefined \(cannot refer to unexported method secret\)|reference to unexported field or method"
