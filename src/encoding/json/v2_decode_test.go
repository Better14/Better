...
var unmarshalTests = []struct {
	...
	{CaseName: Name(""), in: `{"X": 23}`, ptr: new(T), out: T{}, err: &UnmarshalTypeError{Value: "number", Type: reflect.TypeFor[string](), Offset: len64(`{"X": `), Struct: "T", Field: "X"}},
	...
	// raw value errors
	{CaseName: Name(""), in: "\x01 42", err: &SyntaxError{msg: "invalid character '\\x01' looking for beginning of value", Offset: len64(``)}},
	{CaseName: Name(""), in: " 42 \x01", err: &SyntaxError{msg: "invalid character '\\x01' after top-level value", Offset: len64(` 42 `)}},
	{CaseName: Name(""), in: "\x01 true", err: &SyntaxError{msg: "invalid character '\\x01' looking for beginning of value", Offset: len64(``)}},
	{CaseName: Name(""), in: " false \x01", err: &SyntaxError{msg: "invalid character '\\x01' after top-level value", Offset: len64(` false `)}},
	{CaseName: Name(""), in: "\x01 1.2", err: &SyntaxError{msg: "invalid character '\\x01' looking for beginning of value", Offset: len64(``)}},
	{CaseName: Name(""), in: " 3.4 \x01", err: &SyntaxError{msg: "invalid character '\\x01' after top-level value", Offset: len64(` 3.4 `)}},
	{CaseName: Name(""), in: "\x01 \"string\"", err: &SyntaxError{msg: "invalid character '\\x01' looking for beginning of value", Offset: len64(``)}},
	{CaseName: Name(""), in: " \"string\" \x01", err: &SyntaxError{msg: "invalid character '\\x01' after top-level value", Offset: len64(` "string" `)}},
