...
func newParseError(layout, value, layoutElem, valueElem, message string) *ParseError {
	...
	errors.InitCustom(&pe.Layer, "%s", parseErrorMessage(layout, valueCopy, layoutElem, valueElemCopy, message))
	return pe
}
...
func newParseDurationError(message, value string) *parseDurationError {
	...
	errors.InitCustom(&pe.Layer, "%s", parseDurationErrorMessage(message, value))
	return pe
}
