...
func rename(oldname, newname string) error {
	...
	if stringslite.HasPrefix(newname, dirname) {
		...
		return NewLinkError("rename", oldname, newname, ErrInvalid)
	}
...
func Link(oldname, newname string) error {
	return NewLinkError("link", oldname, newname, syscall.EPLAN9)
}
...
func Symlink(oldname, newname string) error {
	return NewLinkError("symlink", oldname, newname, syscall.EPLAN9)
}
