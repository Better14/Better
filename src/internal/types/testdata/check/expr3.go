...
func _calls() {
	...
	f1(g0 /* ERROR "g0() (no value) used as value" */ ())
	f1(g1())
	...
	f2(g0 /* ERROR "g0() (no value) used as value" */ ()) /* ERROR "not enough arguments in call to f2\n\thave (func())\n\twant (float32, string)" */
	f2(g1()) /* ERROR "not enough arguments in call to f2\n\thave (int)\n\twant (float32, string)" */
	f2(g2())

	fs() /* ERROR "not enough arguments" */
	fs(g0 /* ERROR "g0() (no value) used as value" */ ())
